...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateUILanguage() {
        // 使用i18n模块更新页面文本
        if (window.MNIST && window.MNIST.i18n) {
            // confidenceText是动态文本，需要特殊处理
            if (confidenceText && confidenceText.textContent.includes('Draw and click') || 
                confidenceText.textContent.includes('绘制并点击')) {
                confidenceText.textContent = MNIST.i18n.getTranslation('draw_prompt');
            }
    ...
    function init() {
        ...
        setTimeout(() => {
            ...
            console.log('画布初始状态:', isBlank ? '空白' : '有内容');
        }, 500);
    }
    ...
    function clearCanvas() {
        ...
        if (confidenceText) {
            ...
            if (window.MNIST && window.MNIST.i18n) {
                ...
                confidenceText.textContent = 'Draw and click "Predict" to see results';
            }
        }
